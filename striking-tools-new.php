    ...
    <div class="container-fluid">
        <div class="row align-items-center px-5">
            ...
            <div class="col-lg-6 landing-new-forge-hero-content">
                <span class="landing-new-forge-eyebrow" id="landing-new-forge-dyn-eyebrow">Striking Tools</span>
                <h1 id="landing-new-forge-dyn-h1">Forged  <em>Striking Tools</em>  Built for Impact, Strength and Longer Life </h1>
                <p class="landing-new-forge-lead" id="landing-new-forge-dyn-lead">Designed for repeated impact, our forged striking tools offer superior toughness, grip confidence and long-lasting performance in demanding work environments.</p>
            ...
            <!-- Right Form -->
            <div class="col-lg-6">
                <?php $ad_category_default = 'Striking Tools'; include('include/enquiry-form.php'); ?>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid">
        <div class="row" id="category-content">
         <div class="sec-title">
            <div class="sub-title">
               ...
               <h5>High-Impact Forged Tools</h5>
            </div>
            <h2>Striking Tools</h2>
         </div>
      </div>
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 mb-5">                       
                <div class="single-service-style3">
                    <div class="img-holder">
                        <div class="inner">
                            <img src="assets/images/products/striking-tools/1.jpg" alt="">
                        </div>
                    </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 mb-5">                       
                <div class="single-service-style3">
                    <div class="img-holder">
                        <div class="inner">
                            <img src="assets/images/products/striking-tools/2.jpg" alt="">
                        </div>
                    </div>
                    <div class="text-holder text-center">
                        <h2>Sledge Hammer</h2>
            ...
            <!-- <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 mb-5">                       
                <div class="single-service-style3">
                    <div class="img-holder">
                        <div class="inner">
                            <img src="assets/images/products/striking-tools/3.jpg" alt="">
                        </div>
                    </div>
                    <div class="text-holder text-center">
                        <h2>AI 3</h2>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 mb-5">                       
                <div class="single-service-style3">
                    <div class="img-holder">
                        <div class="inner">
                            <img src="assets/images/products/striking-tools/5.jpg" alt="">
                        </div>
                    </div>
                    <div class="text-holder text-center">
                        <h2>Club Hammer</h2>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 mb-5">                       
                <div class="single-service-style3">
                    <div class="img-holder">
                        <div class="inner">
                            <img src="assets/images/products/striking-tools/4.jpg" alt="">
                        </div>
                    </div>
                    <div class="text-holder text-center">
                        <h2>Twisted Wedge Hammer</h2>
                    </div>
                </div>
            </div>
            <!--End Single Service Style3--->
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 mb-5">                       
                <div class="single-service-style3">
                    <div class="img-holder">
                        <div class="inner">
                            <img src="assets/images/products/striking-tools/7.jpg" alt="">
                        </div>
                    </div>
                    <div class="text-holder text-center">
                        <h2>Diamond Wedge Hammer</h2>
                    </div>
                </div>
            </div>
            <!--End Single Service Style3--->
		...
		<div class="row" id="category-content">
         ...
         <div class="sustan-main-heading">
                <p>Our forged striking tools are designed for impact, endurance and operator safety. Manufactured using high-strength alloy steels and precision forging techniques, these tools offer superior grain flow, reduced fracture risk and extended service life. </p>
				<p>Each component undergoes controlled heat treatment for optimal hardness and toughness, followed by dimensional finishing and surface conditioning. </p>
				<p>Ideal for industrial, construction and heavy-duty applications, our striking tools combine metallurgical integrity with ergonomic reliability for demanding work environments.</p>
         </div>
      </div>
    </div>
</section>
