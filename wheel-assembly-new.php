    ...
    <div class="container-fluid">
        <div class="row align-items-center px-5">
            ...
            <div class="col-lg-6 landing-new-forge-hero-content">
                <span class="landing-new-forge-eyebrow" id="landing-new-forge-dyn-eyebrow">Fifth Wheel Assembly Parts</span>
                <h1 id="landing-new-forge-dyn-h1">Robust <em>Fifth Wheel Assembly Parts </em> Engineered for Heavy Transport Safety</h1>
                <p class="landing-new-forge-lead" id="landing-new-forge-dyn-lead">Built for heavy transport safety, our fifth wheel assembly components ensure dependable coupling performance, load stability and long-term road reliability.</p>
            ...
            <div class="col-lg-6">
                <div class="landing-new-forge-form-card" id="landing-new-forge-enquiry">
                    ...
                    <form class="row" action="submit-enquiry.php" method="post">
                        ...
                        <input type="hidden" name="ad_category" id="landing-new-forge-f-adcat" value="Fifth Wheel Assembly Parts">
                        ...
                        <div class="col-12 col-md-12">
                            ...
                            <select id="landing-new-forge-f-cat" name="category" required>
                                ...
                                <option selected>5th Wheel Assembly</option>
