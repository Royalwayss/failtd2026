    ...
    <div class="container-fluid">
        <div class="row align-items-center px-5">
            ...
            <div class="col-lg-6 landing-new-forge-hero-content">
                <span class="landing-new-forge-eyebrow" id="landing-new-forge-dyn-eyebrow">Forged Tractor Parts Manufacturer B7 India</span>
                <h1 id="landing-new-forge-dyn-h1">Forged <em>Tractor Parts</em> Manufacturer for OEMs &amp; Exporters</h1>
                <p class="landing-new-forge-lead" id="landing-new-forge-dyn-lead">High-load closed-die forged tractor components in carbon & alloy steel b  supplied to Sonalika, TAFE, Mahindra and OEMs worldwide.</p>
