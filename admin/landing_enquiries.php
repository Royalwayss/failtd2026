                     ...
                     <table class="table table-striped table-bordered table-hover example-table1" >
                        ...
                        <tbody> 
                           <?php  $count =1;
                              ...
                              $sql = "SELECT * FROM landingpage_enquiries ORDER BY `id` DESC";
                           ...
                           <tr>
                              ...
                              <td style=""><?php echo $row['category']; ?></td>
                              <td style="">
							  
							  <a style="color: #18c5a9;" target="_blank" href="<?php echo $row['page_url']; ?>">Click here</a>
							  ...
							  ?>
							  <a href="landing_page_enquiry_view.php?id=<?php echo $row['id']; ?>" class="<?php echo $view_btn_class; ?>" style="">View</a>
