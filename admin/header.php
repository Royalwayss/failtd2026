  ...
  <body class="fixed-navbar">
    <div class="page-wrapper">
      ...
      <header class="header clf" id="header">
        <div class="page-brand"><a class="link" href="#"><span class="brand"><img src="<?php echo LOGO; ?>" style="margin-top: -18px;"></span><span class="brand-mini"></span></a></div>
						...
						<div id="sidebar-collapse">
						  <ul class="side-menu metismenu res-check">
							   ...
							   <li class="">
							    ...
							    <li class="">
								   <a href="blogs.php"></i><span class="nav-label">Blogs</span></a>
							   </li> 
