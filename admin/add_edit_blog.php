      ...
      <?Php
         if(isset($_GET['id']) && $_GET['id'] != ''){
          $title="Edit";
			  ...
			  $short_description = get_cms_content($row['short_description']);
                  ...
                  <div class="ibox-body">
                     ...
                     <form method="POST"   action="<?php echo $action ; ?>" id="addEdit_blog" enctype="multipart/form-data">
						...
						<div class="col-md-12">
							...
							<textarea id="short_description" name="short_description" ><?php if(!empty($id)){ echo $short_description; } ?></textarea>
                        </div>
                        </div>
						<div class="row">
						<div class="col-md-12">
							<label for="editor">Content:</label>
							<textarea id="editor" name="blog_content"><?php if(!empty($id)){ echo $blog_content; } ?></textarea>
						</div>
						</div>
						
						<div class="row">
						<div class="col-md-12">
									<label for="read_time">Read Time: <small style="color:red"> Example:- 18 min read</small></label><br>
									<input type="text" id="read_time" name="read_time" value="<?php if(!empty($id)){ echo $row['read_time']; } ?>" placeholder="">
								</div>
								</div>
