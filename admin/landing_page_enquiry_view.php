...
<html>
   <head>
      ...
      <?Php
         $id= $_GET['id'];
         $sql = "SELECT *  FROM landingpage_enquiries where id='".$_GET['id']."'"; 
         $result =mysqli_query($conn, $sql);
         $row = mysqli_fetch_assoc($result); 
         if($row['view_status'] == '0'){
            $update_query = "UPDATE landingpage_enquiries SET view_status = '1' WHERE id = ".$row['id']; 
               ...
               <div class="col-md-12">
                  <div class="ibox-body">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6 ">
                           <b><label>Product Category:</label></b><br> 
                           <p style="margin-left:10px"> <?php echo $row['category']; ?> </p>
                        </div>
						
						 <div class="col-md-6 ">
                           <b><label>Requirement / Message:</label></b><br> 
                           <p style="margin-left:10px"> <?php echo $row['message']; ?> </p>
                        </div>
						
						 <div class="col-md-6 ">
                           <b><label>Page:</label></b><br> 
                           <p style="margin-left:10px"><a style="color: #18c5a9;" target="_blank" href="<?php echo $row['page_url']; ?>"><?php echo $row['page_url']; ?></a>
							 </p>
                        </div>
