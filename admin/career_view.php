   ...
   <head>
      ...
      <?Php
         ...
         if($row['view_status'] == '0'){
            $update_query = "UPDATE careers SET view_status = '1' WHERE id = ".$row['id']; 
      ...
      <div class="wrapper content-wrapper">
         ...
         <div class="page-heading">
            <h1 class="page-title"> Career View</h1>
                  ...
                  <div class="ibox-body">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6 ">
                           ...
                           <p style="margin-left:10px"> <?php echo $row['age']; ?> </p>
                        </div>
						<div class="col-md-6 ">
						...
						<div class="col-md-6 ">
						 ...
						 <div class="col-md-6 ">
                           ...
                           <p style="margin-left:10px"> <?php echo $row['experience']; ?> </p>
                        </div>
						
						<div class="col-md-6 ">
                           <b><label>Resume:</label></b><br> 
                          <?php if($row['resume'] != '') { ?> 
						   <p style="margin-left:10px"> <a style="color: #007bff;" target="_black" href="<?php echo BASEURL; ?>uploads/resume/<?php echo $row['resume']; ?>"><?php echo $row['resume']; ?></a> </p>
                          	<?php } ?>
						</div>
					
                        <div class="col-md-6 ">
                           <b><label>Education:</label></b><br> 
                           <p style="margin-left:10px"> <?php echo $row['education']; ?> </p>
                        </div>
