...
include('include/header.php');
 ...
 ?>
 <style>
 .blog-ul { margin-left:50px; margin-bottom:30px; }
 .blog-ul li { list-style: disc !important; }
 .blog-ul li::marker {  color: #ec7d1b;  }
 </style>
        ...
        <div class="row">
            <div class="col-12 col-lg-12 m-auto text-start">
                <div class="blogs-new-banner-content">
                    <h2>titleeeee</h2>
                    <p class="text-white mt-2">Published on: 23-55 | 12 am ?></p>
                </div>
